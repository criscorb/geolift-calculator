...
st.set_page_config(page_title="Pre-Test Calculator | AB InBev", page_icon="🍺", layout="wide")
...
<style>
    ...
    .dataframe th {
        background: var(--abi-navy) !important;
    ...
    .apply-btn {
        background: linear-gradient(135deg, var(--abi-success) 0%, #1B5E20 100%) !important;
        color: white !important;
...
# ============================================
    ...
    # Generate report
    report = f"""# 📊 Plan de GeoLift Test | AB InBev
